...
public class Util {
	...
	/**
	 * Function to get the separator string to be used for directories and files
	 * based on the current OS for Maven Project
	 * 
	 * @return The file separator string for Maven Test Java folder
	 */
	public static String getMavenTestPath() {
		return getFileSeparator() + "src" + getFileSeparator() + "test" + getFileSeparator() + "java"
				+ getFileSeparator();
	}
