package com.changeCX.framework.selenium;
...
import com.changeCX.framework.ObjectMachinate;
...
public class FrameworkDriver {
	...
	/**
	 * Function to return the object for NgWebDriver {@link WebDriver} object
	 *
	 * @return Instance of the {@link NgWebDriver} object
	 */
	public NgWebDriver getNgWebDriver() {
		JavascriptExecutor jsDriver = (JavascriptExecutor) driver;return new NgWebDriver(jsDriver);
	}
