...
import com.changeCX.framework.selenium.WebDriverUtil;
...
public abstract class ReusableLib {
   ...
   // protected static FrameworkDriver driver;
    ...
    protected void clickWithoutWait(By el, String custMsg) {
        try {
            getElement(el).click();
        }
        catch (Exception e) {
    ...
    protected void clickWithoutWait(By el) {
        try {
            getElement(el).click();
        }
        catch (Exception e) {
    ...
    protected void clickWithoutWait(WebElement el, String custMsg) {
        try {
            el.click();
        }
        catch (Exception e) {
    ...
    protected void clickWithoutWait(WebElement el) {
        try {
            el.click();
        }
        catch (Exception e) {
    ...
    protected void vrfyElementExist(By el, String custMsg) {
        try {
    ...
    protected void vrfyElementExist(WebElement el, String custMsg) {
        try {
            waitForVisible(el);
            report.updateTestLog("Verification", custMsg, Status.PASS);
        } catch (NoSuchElementException e) {
    ...
    /**
     * ******************************************************************
     * Name: getListOfWebElementText
     * Author : GSInfo Team
     * Purpose : gets list of text from elements
     * ******************************************************************
     **/
    protected List<String> getListOfWebElementText(By el) {

        List<WebElement> webEl = getListElement(el);
        List<String> ls_text = new ArrayList<>();
        try {
            if (webEl.isEmpty()) {
