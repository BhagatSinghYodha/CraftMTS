...
import com.changeCX.framework.selenium.SeleniumReport;
...
public class Utility_Functions extends ReusableLib {
    ...
    /*
     * ******************************************************************* Function
     * Name: Random String Function Author : MTS Team Purpose :
     * ******************************************************************
     */
...
//"src/test/resources/Datatables/RunTimeData.json";
    /*
     * ******************************************************************* Function
     * Name: xHighlight Author : MTS Team Highlight the element Parameters:
...
//			newDate = sdf.format(dtDob);
    ...
    /*
     * ******************************************************************* Function
     * Name: inputData Author : MTS Team Inputs the data: tagID, value
     * ******************************************************************
     */
    ...
    /*
     * ******************************************************************* Function
     * Name: inputData Author : MTS Team
    ...
    // ******************************************************************
    /*
     * Function Name: findWebElementById Author : MTS Team Element finder by
     * ID ******************************************************************
     */
    ...
    /*
     * ******************************************************************* Function
     * Name: xSelectRadio Author : MTS Team Selects the radio button : driver,
     * webelement ******************************************************************
     */
     ...
     * xWaitForElementClickable, xWaitForElementAttribute Author : Team MTS :
    ...
    /*
     * ******************************************************************* Function
     * Name: validateFieldMatch Author : MTS Team Validates field match:
    ...
    /*
     * ******************************************************************* Function
     * Name: xClickButton Author : MTS Team Added to click on Button items of
    ...
    /*
     * ******************************************************************* Function
     * Name: xClick Author : MTS Team Click on element with or without
    ...
    /*
     * ******************************************************************* Function
     * Name: findWebElementBylinkText Author : MTS Team Purpose : Element
     * finder by linkText
     * ******************************************************************
     */
    ...
    /*
     * ******************************************************************* Function
     * Name: findWebElementByXpath Author : MTS Team : Element finder by xpath
     * ******************************************************************
     */
    ...
    public static void xClickHiddenElement(FrameworkDriver driver, Report report, By element, String CustomMsg) {
        JavascriptExecutor js = (JavascriptExecutor) driver.getWebDriver();
        js.executeScript("arguments[0].click()", driver.findElement(element));
        report.updateTestLog("Click", CustomMsg, Status.PASS);
    }

    public static void xClickHiddenElement(FrameworkDriver driver, Report report, WebElement element, String CustomMsg) {
        JavascriptExecutor js = (JavascriptExecutor) driver.getWebDriver();
        js.executeScript("arguments[0].click()", element);
        report.updateTestLog("Click", CustomMsg, Status.PASS);
    }
    ...
    /*
     * ******************************************************************* Function
     * Name: xClickVisibleListElement Author : MTS Team Purpose : Click the
    ...
    /*
     * ******************************************************************* Function
     * Name: inputValueWithReport Author : MTS Team : Inputs the value with in
    ...
    /*
     * ******************************************************************* Function
     * Name: xSelectDropdown,xSelectDropdownByName Author : MTS Team
    ...
    /*
     * ******************************************************************* Function
     * Name: xmouseOver Author : MTS Team
    ...
    /*
     * **********************************************************************************************
     * Function Name: xRandomFunction Author : MTS Team Purpose : generate random Int in range
     * **********************************************************************************************
     */
...
//		};
    ...
    public static void xScrollIntoViewClck(FrameworkDriver driver, By el) {

        String mouseScript = "arguments[0].scrollIntoView();";
        String mouseScript1 = "arguments[0].click();";
        JavascriptExecutor js = (JavascriptExecutor) driver.getWebDriver();
        js.executeScript(mouseScript, driver.findElement(el));
        js.executeScript(mouseScript1, driver.findElement(el));
    }
    ...
    /*
     * ******************************************************************* Function
     * Name: xScrollWindow Author : MTS Team Hover and action Parameters:
     * driver ******************************************************************
     */
    ...
    /*
     * ******************************************************************* Function
     * Name: xHighlight Author : MTS Team Purpose : Highlight the element
    ...
    /**
     * ******************************************************************* Function
     * Name: xScrollElementToCentre
     * Author : MTS Team
     * Purpose : Scroll element to centre of page
     * ******************************************************************
     **/

    public static void xScrollElementToCentre(FrameworkDriver driver, By el) {
        xWaitForElementPresent(driver, el, 15);
        String mouseScript = "arguments[0].scrollIntoView({block: 'center', inline: 'nearest'})";
        JavascriptExecutor js = (JavascriptExecutor) driver.getWebDriver();
        js.executeScript(mouseScript, driver.findElement(el));
    }
    ...
    public static void xScrollElementToCentre(FrameworkDriver driver, WebElement el) {
        xWaitForElementPresent(driver, el, 15);
        String mouseScript = "arguments[0].scrollIntoView({block: 'center', inline: 'nearest'})";
        JavascriptExecutor js = (JavascriptExecutor) driver.getWebDriver();
        js.executeScript(mouseScript, el);
    ...
    /*
     * ******************************************************************* Function
     * Name: xSwitc Author : MTS Team Purpose : Highlight the element
     * Parameters: driver, webelement, color = e.g yellow, green etc
     * ******************************************************************
     */
    ...
    /*
     * ******************************************************************* Function
     * Name: xSelectDropdownByNameRandomValue Author : MTS Team Purpose : Select Random value in dropdown
     * Parameters: driver, e
     * ******************************************************************
     */
    ...
    /*
     * ******************************************************************* Function
     * Name: xContainsvalue Author : MTS Team Takes a given driver and window
    ...
    /*
     * ******************************************************************************************************
     * Function Name: xgetDropdownValueText Author : MTS Team Purpose : get Dropdown Options as list
     * ******************************************************************************************************
     */
    ...
    /*
     * ******************************************************************* Function
     * Name: xSendKeys Author : MTS Team Send keys to the input field: driver,
    ...
    public static void xSendKeysAction(FrameworkDriver driver, By el, String strVal) {
        xWaitForElementPresent(driver, el, 10);
        Actions builder = new Actions(driver.getWebDriver());
        WebElement elementLocator = driver.findElement(el);
        builder.sendKeys(elementLocator, strVal).build().perform();
    }

    public static void xSendKeysAction(FrameworkDriver driver, WebElement el, String strVal) {
        xWaitForElementPresent(driver, el, 10);
        Actions builder = new Actions(driver.getWebDriver());
        builder.sendKeys(el, strVal).build().perform();
    }

    public static void xSendKeysJS(FrameworkDriver driver, By el, String strVal) {
        xWaitForElementPresent(driver, el, 10);
        WebElement elementLocator = driver.findElement(el);
        JavascriptExecutor jse = (JavascriptExecutor)driver.getWebDriver();
        jse.executeScript("arguments[0].setAttribute('value', '"+ strVal +"')", elementLocator);
    }

    public static void xSendKeysJS(FrameworkDriver driver, WebElement el, String strVal) {
        xWaitForElementPresent(driver, el, 10);
        JavascriptExecutor jse = (JavascriptExecutor)driver.getWebDriver();
        jse.executeScript("arguments[0].setAttribute('value', '"+ strVal +"')", el);
    }
    ...
    /*
     * ******************************************************************* Function
     * Name: xSendKeysVisibleListElement Author : MTS Team Purpose : SendKeys
    ...
    /*
     * ******************************************************************* Function
     * Name: Miscellaneous functions Author : MTS Team Purpose : Hover and
    ...
    /*
     * ******************************************************************* Function
     * Name: xSwitc Author : MTS Team Purpose : Switch to Parent Window
